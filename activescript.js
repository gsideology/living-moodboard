...
window._show_thank_you = function (id, message, trackcmp_url, email) {
  ...
  // creat un intervallo per far apparire il form dopo 1 secondo

  setTimeout(function () {
    form.querySelector("._form-content").style.display = "flex";
  }, 3000);
...
(function () {
      ...
      if (
        ...
        for (var i = 0; i < elems.length; i++) {
          ...
          if (!elems[i].checked) {
            ...
            err.push(
              "È necessario verificare %s".replace("%s", elems[i].value)
            );
          }
        }
        if (!no_error) {
  ...
  var form_submit = function (e) {
    ...
    if (validate_form()) {
      ...
      _load_script(
        "https://in20abitare.activehosted.com/proc.php?" +
          serialized +
          "&jsonp=true",
        null,
        true
  ...
  addEvent(form_to_submit, "submit", form_submit, captureAndDownloadPng);
})();
